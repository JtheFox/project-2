...
router.get('/', withAuth, async (req, res) => {
  ...
  try {
    ...
    //Return in json file
    res.json(displayProfile, { loggedIn: req.session.loggedIn });
...
router.get('/:id', withAuth, async (req, res) => {
  ...
  try {
    ...
    res.json(findProfile, { loggedIn: req.session.loggedIn });
...
router.post('/', withAuth, async (req, res) => {
  ...
  try {
    ...
    //Return profile in json  
    res.json(createProfile, { loggedIn: req.session.loggedIn });
